...
const PaginationLink = ({
  ...
  <button
    ...
    className={cn(
      ...
      `${isActive ? "bg-grey-900 text-white border-0" : "border border-input"}`,
      className
    )}
    {...props}
  />
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn(
      "gap-4 pl-5 pr-4 border border-input rounded-[8px]",
      className
    )}
    {...props}
  >
...
const PaginationNext = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn(
      "gap-4 pl-4 pr-5 border border-input rounded-[8px]",
      className
    )}
    {...props}
  >
